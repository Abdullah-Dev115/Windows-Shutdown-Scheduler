...
Icon = PhotoImage(file="shutdown.png")
...
created_by = ttk.Label(Shutdown, text="Created by Abo0od-Div115", font=("Arial", 9))
created_by.place(x=79, y=260)

github_link = Label(Shutdown, text="Abo0od's Github", font=('Helveticabold', 10), fg="blue", cursor="hand2")
github_link.place(x=100, y=280)
github_link.bind("<Button-1>", lambda e: callback("https://github.com/Abo0od-Dev115"))
